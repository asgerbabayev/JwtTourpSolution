...
namespace TourP.Business.Constants
{
    public static class Messages
    {
        ...
        internal static string VerifyMailForLogin = "Please verify your mail.";
        internal static string MailIsVerified = "Email is verified.";
        internal static string PasswordRecoveryMail = "Password recovery email sent.";
        internal static string ErrorFound = "Error Found";
